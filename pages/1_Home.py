...
with col1:
    ...
    """)
    st.page_link("2_🚮_Find_Collection_Point.py", label="Find nearest points", icon="🚮")
...
with col2:
    ...
    """)
    st.page_link("3_🔍_Identify_Waste.py", label="Identify your waste", icon="🔍")
...
with col3:
    ...
    """)
    st.page_link("4_ℹ️_About.py", label="About us", icon="ℹ️")
